	...
	BootstrapTable.prototype.initToolbar = function () {
		...
		if (this.options.showToggle) {
			html.push(
                ...
                if (this.options.showToggle1) {
			html.push(
				'<button class="btn btn-default" type="button" title="%s" onClick ="export_it1('+"'pdf'"+');">pdf</button>'
				+'<button class="btn btn-default" type="button" title="%s" onClick ="export_it1('+"'csv'"+');" >csv</button>'
				+'<button class="btn btn-default" type="button" title="%s" onClick ="export_it1('+"'excel'"+');" >xls</button>');
		}
