        ...
        foreach ($all_subscribe_email as $row) {
            $subscribers_list[] = $row['email'];
        }
        $subscribers_list = join(',', $subscribers_list);
        ?>
    <h4 class="modal-title text-center padd-all"><?php echo translate('export_subscriber_email_addresses');?> </h4>
	<hr style="margin: 10px 0 !important;">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <textarea id="DES" rows="10" cols="30"  class="form-control"><?php echo $subscribers_list; ?></textarea>
                        <input id="temp_email" type="hidden" value="<?php echo $subscribers_list; ?>"/>
                    </div>
                </div>
            </div>
</form>
