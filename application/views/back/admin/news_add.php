                        ...
                        <div class="panel panel-bordered-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="news_title" class="form-control" id="news-title" placeholder="News Title">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="news_text" id="news-text"></textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    <button class="btn btn-purple" type="submit">Add News</button>
                                </div>
