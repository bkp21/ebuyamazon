...
<div id="content-container">
    <div id="page-title">
        <h1 class="page-header text-overflow" ><?php echo translate('Bulk Category Image Upload');?></h1>
    </div>
                    ...
                    <div class="tab-pane fade active in"  id="" >
                        <div class="panel panel-bordered-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <?php echo form_open("admin/bulk_category_image_upload_process", array('class'=>'dropzone', 'id'=> 'uploader')); ?>
