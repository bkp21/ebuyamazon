...
<div id="content-container">
    <div id="page-title">
        <h1 class="page-header text-overflow" ><?php echo translate('Recommended Products (Family) (Update) ');?></h1>
    </div>
    <div class="tab-base">
        <div class="panel">
                        ...
                        <div class="panel panel-bordered-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table table-responsive table-bordered table-hover">
                                    ...
                                    <tr><td>Category(s) Product Will Be Listed In :</td><td><input style="width: 400px;" type="text" name="promo_name" value="<?php echo set_value('promo_name',$info->rp_name); ?>"> </td></tr>
