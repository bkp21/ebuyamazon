<div>
    <?php
    echo form_open(base_url() . 'index.php/admin/vendor_badges_awards/do_add1/', array(
        'class' => 'form-horizontal',
        'method' => 'post',
        'id' => 'vendor_awards_add',
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="award_name" id="demo-hor-1" 
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="award_from" value='0' id="demo-hor-2" 
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="award_to" value='0' id="demo-hor-3" 
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <span class="pull-left btn btn-default btn-file">
                    <?php echo translate('select_award_logo'); ?>
