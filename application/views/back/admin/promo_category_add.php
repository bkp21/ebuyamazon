                        ...
                        <div class="panel panel-bordered-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table table-responsive table-bordered table-hover">
                                    ...
                                    <tr><td>Promo Category Name :</td><td><input type="text" name="promo_name"> </td></tr>
                                    ...
                                    <tr><td>active :</td><td><input type="checkbox" name="active" checked="checked" value="true">  </td></tr>
                                    ...
                                    <tr>
                                        <td>Promotion URL :</td>
                                        <td><input style="width: 100%"  type="text" name="promotional_url"></td>
                                    </tr>
                                </table>
                                <table class="table table-responsive table-bordered table-hover">
