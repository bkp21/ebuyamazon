		...
		?>
            <div class="panel-body">
                <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                            <input type="radio" name="is_approved" id="demo-hor-5"  value="approved"<?php if($row['is_approved']=='approved'){ echo 'checked';} ?>/><?php echo translate('approved'); ?>
                            <input type="radio" name="is_approved" id="demo-hor-5"  value="pending"<?php if($row['is_approved']=='pending'){ echo 'checked';} ?>/><?php echo translate('pending'); ?>
                            <input type="radio" name="is_approved" id="demo-hor-5"  value="declined"<?php if($row['is_approved']=='declined'){ echo 'checked';} ?>/><?php echo translate('declined'); ?>
                    </div>
                </div>
                <div class="form-group btm_border">
				<div>
                    ...
                    <div class="col-sm-6">
                        <textarea name="approval_note" class="form-control" rows="3" ><?php echo $row['approval_note'];?></textarea>
                    </div>
                </div>
            </div>  
            <!--Panel heading-->
                    ...
                    <div class="tab-content">
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <?php echo $this->crud_model->select_html('vendor','vendor','name','edit','demo-chosen-select',$row['vendor_id'],'','',''); ?>
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <select name="category" class="demo-chosen-select form-control required" id="select_cat" onchange="cat_type(this.value);">
                                      ...
                                      foreach ($all_category as $category) {
                                          ?>
                                          <option value="<?php echo $category['category_id']; ?>"<?php if ($category['category_id'] == $row['category']) {
                                            echo 'selected';
                                        } ?>>
...
<!--                            <div class="form-group btm_border" id="sub" >
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="meta_keyword" id="demo-hor-1" value="<?php echo $row['meta_keyword']; ?>" placeholder="<?php echo translate('meta_keyword');?>" class="form-control required">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="meta_title_tag" id="demo-hor-1" value="<?php echo $row['meta_title']; ?>" placeholder="<?php echo translate('meta_title_tag');?>" class="form-control required">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input name="is_condition" onchange="condition_type(this.value);" type="radio" value="0"<?php if($row['is_condition_new']=='0'){ echo 'checked';} ?>/>New<br />
                                    <input name="is_condition" onchange="condition_type(this.value);" type="radio" value="1"<?php if($row['is_condition_new']=='1'){ echo 'checked';} ?> />Used<br />
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-11"><?php echo translate('condition_details');?></label>
                                      <?php 
                                        if($row['is_condition_new'] == '0') { $display="block"; }
                                        else{ $display="none";}
                                      ?>
                                        ...
                                        <select class="demo-chosen-select" name="item_condition_new">
                                            ...
                                            ?>
                                                 <option value="<?php echo $dylist['item_id']; ?>"
                                                     <?php if($row['item_condition']==$dylist['item_id']){ echo 'selected';} ?>>
                                                     <?php echo $dylist['item_name'];?></option>
                                            <?php } } ?>
                                        </select>
                                    </div>
                                      <?php 
                                        if($row['is_condition_new'] == '1') { $display1="block"; }
                                        else{ $display1="none";}
                                      ?>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" name="priority" min="0" id="demo-hor-5" value="<?php echo $row['priority']; ?>" placeholder="<?php echo translate('priority'); ?>" class="form-control  required">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="mpn" id="demo-hor-5" value="<?php echo $row['mpn']; ?>" placeholder="<?php echo translate('manufacturer_product_number'); ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="gtin" id="demo-hor-5" value="<?php echo $row['gtin']; ?>" placeholder="<?php echo translate('global_trade_item_number'); ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="radio" name="product_subtype" id="demo-hor-5"  value="normal"<?php if($row['product_subtype']=='normal'){ echo 'checked';} ?>/><?php echo translate('normal'); ?>
                                    <input type="radio" name="product_subtype" id="demo-hor-5"  value="subscribe"<?php if($row['product_subtype']=='subscribe'){ echo 'checked';} ?>/><?php echo translate('subscribe'); ?>
                                    <input type="radio" name="product_subtype" id="demo-hor-5"  value="music"<?php if($row['product_subtype']=='music'){ echo 'checked';} ?>/><?php echo translate('music'); ?>
                                    <input type="radio" name="product_subtype" id="demo-hor-5"  value="service"<?php if($row['product_subtype']=='service'){ echo 'checked';} ?>/><?php echo translate('shop_services '); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" min="0.00" name="item_price" value="<?php echo $row['item_price']; ?>" id="demo-hor-14" placeholder="<?php echo translate('item_price'); ?>" class="form-control required">
                                   
                                </div>
                                <div class="col-sm-2">
                                    <input type="checkbox" name="call_for_price" value="yes"<?php if($row['call_for_price']=='yes'){ echo 'checked';} ?>> <?php echo translate('call_for_price');?>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="checkbox" name="is_taxable"  id="demo-hor-5" value="yes"<?php if($row['is_taxable']=='yes'){echo 'checked';}?>>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                     <input type="number" name="tax_rate" min="0" step='.01' id="demo-hor-5" value="<?php echo $row['tax_rate']; ?>" placeholder="<?php echo translate('tax_rate'); ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" name="supplier_price" min="0" step='.01' id="demo-hor-5" value="<?php echo $row['supplier_price']; ?>" placeholder="<?php echo translate('supplier_price'); ?>" class="form-control  required">
                                </div>
                            </div>
                           ...
                           <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <?php echo $this->crud_model->select_html('suppliers','suppliers','supplier_name','edit','demo-chosen-select',$row['suppliers_id'],'','',''); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="checkbox" name="free_shipping"  id="demo-hor-5" value="yes"<?php if($row['free_shipping']=='yes'){echo 'checked';}?>>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <?php 
                                        $allcontry = ['0'];
                                        $con_id = json_decode($row['country_id']);
                                        foreach ($allcontry as $con)
                                          {
                                        ?>                      
                                        <option value="0" <?php if($row['country_id']==null){echo '';}elseif(in_array($con['0'],$con_id)) echo 'selected' ?>><?php echo translate('all_countries');?></option> 
                                    <?php } ?>    
                                    <?php 
                                        $con_id = json_decode($row['country_id']); 
                                     ...
                                     ?>
                                         <option value="<?php echo $country['id']; ?>"<?php
                                              if($row['country_id']==null){echo '';}elseif(in_array($country['id'],$con_id)){ echo 'selected'; } ?>>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                   <input type="number" name="weight" min="0" step='.01' id="demo-hor-5" value="<?php echo $row['weight']; ?>" placeholder="<?php echo translate('unit_weight'); ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" name="shipping_price" min="0" step='.01' id="demo-hor-5" value="<?php echo $row['shipping_price']; ?>" placeholder="<?php echo translate('shipping_price'); ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-3">
                                   <input type="text" name="inter_pack" id="demo-hor-5" value="<?php echo $row['inter_pack']; ?>" placeholder="<?php echo translate('inter_pack'); ?>" class="form-control">
                                </div>
                                <div class="col-sm-3">
                                   <input type="text" name="case_pack" id="demo-hor-5" value="<?php echo $row['case_pack']; ?>" placeholder="<?php echo translate('case_pack'); ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" name="dimension_width" id="demo-hor-5" value="<?php echo $row['dimension_width']; ?>" placeholder="<?php echo translate('width'); ?>" class="form-control">
                                </div>
                                <div class="col-sm-2">
                                   <input type="text" name="dimension_height" id="demo-hor-5" value="<?php echo $row['dimension_height']; ?>" placeholder="<?php echo translate('height'); ?>" class="form-control">
                                </div>
                                <div class="col-sm-2">
                                   <input type="text" name="dimension_length" id="demo-hor-5" value="<?php echo $row['dimension_length']; ?>" placeholder="<?php echo translate('length'); ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="radio" name="shipping_by" id="demo-hor-5"  value="mall"<?php if($row['shipping_by']=='mall'){ echo 'checked';} ?>/><?php echo translate('mall'); ?><br>
                                    <input type="radio" name="shipping_by" id="demo-hor-5"  value="vendor"<?php if($row['shipping_by']=='vendor'){ echo 'checked';} ?>/><?php echo translate('vendor'); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                  <input type="number" name="shipping_days" min="0"  id="demo-hor-5" value="<?php echo $row['shipping_days']; ?>" placeholder="<?php echo translate('shipping_days'); ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="checkbox" name="is_hotdeal"  id="demo-hor-5" value="yes"<?php if($row['is_hotdeal']=='yes'){echo 'checked';}?>>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="checkbox" name="is_home"  id="demo-hor-5" value="yes"<?php if($row['is_home']=='yes'){echo 'checked';}?>>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="checkbox" name="is_vendor_home"  id="demo-hor-5" value="yes"<?php if($row['is_vendor_home']=='yes'){echo 'checked';}?>>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="checkbox" name="is_vendor_special"  id="demo-hor-5" value="yes"<?php if($row['is_vendor_special']=='yes'){echo 'checked';}?>>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="checkbox" name="is_template"  id="demo-hor-5" value="1"<?php if($row['is_template']=='1'){echo 'checked';}?>>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="checkbox" name="user_req"  id="demo-hor-5" value="1"<?php if($row['user_req']=='1'){echo 'checked';}?>>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="checkbox" name="price_offer"  id="demo-hor-5" value="1"<?php if($row['price_offer']=='1'){echo 'checked';}?>>
                                </div>
                            </div>
                             ...
                             <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <input type="checkbox" name="rmaactive"  id="demo-hor-5" value="1"<?php if($row['rmaactive']=='1'){echo 'checked';}?>>
                                </div>
                            </div>
                               ...
                               <label class="col-sm-4 control-label" for="demo-hor-5"><?php echo translate('return_and_refund_policy');?></label>
                                <div class="col-sm-6" id="used_condition">
                                    <select class="demo-chosen-select" name="refund_days">
                                        ...
                                        ?>
                                        <option value="<?php echo $dylist['item_id']; ?>"
                                                <?php if($row['refund_days']==$dylist['item_id']){ echo 'selected';} ?>>
                                                <?php echo $dylist['item_name'];?></option>
                                        <?php } } ?>
                                    </select>  
                                </div>
                               ...
                               <label class="col-sm-4 control-label" for="demo-hor-5"><?php echo translate('return_shipping_payment');?></label>
                                <div class="col-sm-6" id="used_condition">
                                    <select class="demo-chosen-select" name="refund_shipping">
                                       <option value="buyer"<?php if($row['refund_shipping']== 'buyer'){ echo 'selected';}?>><?php echo translate('buyer_pays_return_shipping') ?></option>
                                       <option value="seller"<?php if($row['refund_shipping']=='seller') {echo 'selected';}?>><?php echo translate('seller_pays_return_shipping')?></option>
                                    </select>  
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                <div class="col-sm-12">
                                    <textarea rows="9" class="summernotes" data-height="200" data-name="quick_overview">
                                        <?php echo $row['quick_overview']; ?></textarea>
                                </div>
                            </div>
                            <div  class="form-group btm_border title list-title">
                                <i class="glyphicons-icon glyphicon-custom-sidebar notes"></i>
                            ...
                            <div class="form-group btm_border">
                                <div class="col-sm-12">
                                    <textarea rows="9" class="summernotes" data-height="200" data-name="specifications">
                                        <?php echo $row['specifications']; ?></textarea>
                                </div>
                            </div>
                            <?php
                        ...
                        <div id="inventory" class="tab-pane fade">
                                ...
                                <div class="form-group btm_border">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="radio" name="inventory_control" onchange="inventory_type(this.value);" value="no"
                                               <?php if($row['inventory_control']=='no'){ echo 'checked';} ?>><?php echo translate('no_inventory_tracking'); ?><br>
                                        <input type="radio" name="inventory_control" onchange="inventory_type(this.value);" value="yes"
                                               <?php if($row['inventory_control']=='yes'){ echo 'checked';} ?>><?php echo translate('track_inventory_at_product_level'); ?>
                                    </div>
                                </div>
                                <?php 
                                    if($row['inventory_control'] == 'yes') { $display="block"; }
                                    else{ $display="none";}
                                ?>
                            <div id="inventory_div" style="display:<?php echo $display; ?>">    
                                ...
                                <div class="form-group btm_border">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="demo-chosen-select op_type required" name="inventory_rule" >
                                            <option value="hide"<?php if($row['inventory_rule']=='hide'){ echo 'selected'; } ?>><?php echo translate('do_not_display_item_on_user_site'); ?></option>
                                            <option value="out_of_stock"<?php if($row['inventory_rule']=='out_of_stock'){ echo 'selected'; }  ?>><?php echo translate('display_out_of_stock_message');?></option>
                                        </select>
                                    </div>
                                </div>
                                <div  class="form-group btm_border title list-title">
                                ...
                                <div class="form-group btm_border">
                                    ...
                                    <div class="col-sm-4">
                                         <input type="number" name="stock" min="0" id="demo-hor-5" value="<?php echo $row['stock']; ?>"  class="form-control">
                                    </div>
                                </div>
                                <div class="form-group btm_border">
                                    ...
                                    <div class="col-sm-4">
                                         <input type="number" name="stock_warning" min="0" id="demo-hor-5" value="<?php echo $row['stock_warning']; ?>" class="form-control">
                                    </div>
                                </div>
                            </div>   
                        </div>
                        <div id="business_details" class="tab-pane fade">                       
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" name="old_price" id="demo-hor-6" min='0' step='.01'  value="<?php echo $row['old_price']; ?>"  placeholder="<?php echo translate('old_price');?>" class="form-control required">
                                </div>
                            </div>
