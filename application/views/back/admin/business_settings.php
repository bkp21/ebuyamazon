    ...
    <div class="tab-base">
        <div class="tab-base tab-stacked-left">
            <?php
                ...
                $mp_type   = $this->db->get_where('business_settings', array(
            ...
            <div class="panel panel-bordered-dark">
                ...
                ?>
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" ><?php echo translate('marketplace_type');?></label>
                            <div class="col-sm-6">
                                <select name="marketplace_type" class="demo-cs-multiselect">
                                    <option value="subscriptions_based" 
										<?php if($mp_type == 'subscriptions_based'){ echo 'selected'; } ?> >
                                        	<?php echo translate('subscriptions_based');?>
                                    			</option>
                                    <option value="free" 
										<?php if($mp_type == 'free'){ echo 'selected'; } ?> >
