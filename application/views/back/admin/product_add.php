    ...
    <div class="col-md-12">
        ...
        <div class="panel-body">
            <div class="form-group btm_border">
                    <label class="col-sm-4 control-label" for="demo-hor-13"><?php echo translate('approved_for_the_storefront');?></label>
                    <div class="col-sm-6">
                            <input type="radio" name="is_approved" value="approved" /><?php echo translate('approved'); ?>
                            <input type="radio" name="is_approved"  value="pending" checked="checked"/><?php echo translate('pending'); ?>
                            <input type="radio" name="is_approved"   value="declined"/><?php echo translate('declined'); ?>
                    </div>
            </div>
            <div class="form-group btm_border">
