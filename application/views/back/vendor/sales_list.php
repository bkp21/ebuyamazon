<div class="panel-body" id="demo_s">
    <table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true"  data-show-toggle="true" data-show-columns="true" data-search="true" >
        ...
        <tr class="<?php if($row['viewed'] !== 'ok'){ echo 'pending'; } ?>" >
            ...
            <td class="pull-right"><?php $setrt = $this->crud_model->vendor_share_in_sale($row['sale_id'],$this->session->userdata('vendor_id')); echo currency().$this->cart->format_number($setrt['total']); ?></td>
            <td>
                <?php 
    ...
    <div id='export-div' style="padding:40px;">
        ...
        <table id="export-table" class="table" data-name='sales' data-orientation='l' data-width='1500' style="display:none;">
                ...
                <tr>
                    ...
                    <td><?php echo $this->crud_model->get_type_name_by_id('user',$row['buyer'],'username'); ?></td>
                    <td><?php echo date('d-m-Y',$row['sale_datetime']); ?></td>
                    <td><?php $setrt = $this->crud_model->vendor_share_in_sale($row['sale_id'],$this->session->userdata('vendor_id')); echo currency().$this->cart->format_number($setrt['total']); ?></td>               
                </tr>
                <?php
                        }
                    }
