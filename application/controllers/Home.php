...
class Home extends CI_Controller
{
    ...
    { 
        ...
        if($maintCheck->front != 0 and $maintCheck->status==1){
            ...
            if($whiteIp != null){
                ...
                if(in_array($_SERVER['REMOTE_ADDR'], $whiteIp)){
                  ...
                  $html = str_replace("{{message}}",$maintCheck->message, $html);
                    echo $html;
                    exit();
                }
                ...
                // redirect("home/maintenance");
                $html = $html = file_get_contents('./html/maint.inc');
                $html = str_replace("{{message}}",$maintCheck->message, $html);
                echo $html;
                exit();
            }
    ...
    function listed($para1 = "", $para2 = "", $para3 = "")
    {
        ...
        if ($para1 == "click") {
            ...
            if (isset($rowc)) {
                ...
                if ($setter == 'get') {
                    $cat = $this->crud_model->get_type_name_by_id('sub_category', $sub_category[0], 'category_id');
                }
            }
            if ($cat !== '') {
                if ($cat !== '0') {
